/**
 * Function to list all filters that can be used when searching with the Shodan Trends API.
 *
 * @param {Object} args - Arguments for the request.
 * @param {string} args.apiKey - The API key required to authenticate the request.
 * @returns {Promise<Object>} - The response from the API containing the list of search filters.
 */
const executeFunction = async ({ apiKey }) => {
  ...
  try {
    ...
    const url = new URL(`${baseUrl}/api/v1/search/filters`);
...
/**
 * Tool configuration for listing search filters on Shodan Trends API.
 * @type {Object}
 */
const apiTool = {
  ...
  definition: {
    ...
    function: {
      ...
      description: 'List all filters that can be used when searching with the Shodan Trends API.',
      parameters: {
        type: 'object',
        properties: {
          apiKey: {
